...
- Lokale Konfigurationsdateien und gespeicherter Hunter-Status
- Benachrichtigungs-Kanäle und zugehörige Zugangsdaten
- Autostart-Skripte und Prozess-/Lock-Handling
- Aufrufe der lokal installierten Claude Code CLI
...
- Local configuration files and persisted hunter state
- Notification channels and their credentials
- Autostart scripts plus process/lock handling
- Calls to the locally installed Claude Code CLI
